        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default credit-card-box">
                <div class="panel-heading display-table" >
                        <h3 class="panel-title" style="font-size:22px; font-weight:700" >Payment Details</h3>
                </div>
                <div class="panel-body">
                    ...
                    <form
                        ...
                        <div class="row" >
                            <div class="col-xs-12" >
                                <input type="submit"  value="Pay Now" style="border-radius: 20px; background:rgb(23, 74, 155); ">
                            </div>
                        </div>
