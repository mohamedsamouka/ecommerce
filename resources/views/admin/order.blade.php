                ...
                <table class="table_deg">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{url('delivered',$order->id)}}"onclick="retuern confirm('Are you sure this product is delivered !!!')" class="btn btn-primary" >Delivered</a>
                            @else <p style="color: green">Delivered</p>
                            @endif
                        </td>
                        <td>
